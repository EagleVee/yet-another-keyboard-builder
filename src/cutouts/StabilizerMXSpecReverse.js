...
export class StabilizerMXSpecReverse extends CutoutGenerator {
    generate(key, generatorOptions) {
        ...
        const pointA = [
            new Decimal('-3.3274').plus(generatorOptions.kerf).toNumber(),
            new Decimal('-5.6896').plus(generatorOptions.kerf).toNumber(),
        ];
        const pointB = [
            new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
            new Decimal('-5.6896').plus(generatorOptions.kerf).toNumber(),
        ];
        const pointC = [
            new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
            new Decimal('6.604').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointD = [
            new Decimal('1.524').minus(generatorOptions.kerf).toNumber(),
            new Decimal('6.604').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointE = [
            new Decimal('1.524').minus(generatorOptions.kerf).toNumber(),
            new Decimal('7.7724').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointF = [
            new Decimal('-1.524').plus(generatorOptions.kerf).toNumber(),
            new Decimal('7.7724').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointG = [
            new Decimal('-1.524').plus(generatorOptions.kerf).toNumber(),
        ...
        const pointI = [
            new Decimal('-3.3274').plus(generatorOptions.kerf).toNumber(),
            new Decimal('0.508').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointJ = [
            new Decimal('-4.191').plus(generatorOptions.kerf).toNumber(),
            new Decimal('0.508').minus(generatorOptions.kerf).toNumber(),
        ];
        const pointK = [
            new Decimal('-4.191').plus(generatorOptions.kerf).toNumber(),
            new Decimal('-2.286').plus(generatorOptions.kerf).toNumber(),
        ];
        const pointL = [
            new Decimal('-3.3274').plus(generatorOptions.kerf).toNumber(),
            new Decimal('-2.286').plus(generatorOptions.kerf).toNumber(),
        ...
        if (keySize.gte(3)) {
            pointW = [
                new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
                new Decimal('-2.3').plus(generatorOptions.kerf).toNumber(),
            ];
            pointZ = [
                new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
                new Decimal('2.3').minus(generatorOptions.kerf).toNumber(),
            ];

            pointXL = [
                new Decimal(stab_spacing_left).toNumber(),
                new Decimal('-2.3').plus(generatorOptions.kerf).toNumber(),
            ];
            pointXR = [
                new Decimal(stab_spacing_right).toNumber(),
                new Decimal('-2.3').plus(generatorOptions.kerf).toNumber(),
            ];
            pointYL = [
                new Decimal(stab_spacing_left).toNumber(),
            ...
            pointW = [
                new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
                new Decimal('-4.8768').plus(generatorOptions.kerf).toNumber(),
            ];
            pointZ = [
                new Decimal('3.3274').minus(generatorOptions.kerf).toNumber(),
                new Decimal('5.8166').minus(generatorOptions.kerf).toNumber(),
            ];
        ...
        if (generatorOptions.stabilizerFilletRadius.gt(0)) {
            ...
            for (let currCutout of [cutoutLeft, cutoutRight]) {
                const fillet1 = makerjs.path.fillet(
                    currCutout.paths.line1,
                    currCutout.paths.line2a,
                    filletNum
                );
                const fillet1a = makerjs.path.fillet(
                    currCutout.paths.line2a,
                    currCutout.paths.line2b,
                    filletNum
                );
                const fillet1b = makerjs.path.fillet(
                    currCutout.paths.line2c,
                    currCutout.paths.line2d,
                    filletNum
                );
                const fillet2 = makerjs.path.fillet(
                    currCutout.paths.line2d,
                    currCutout.paths.line3,
                    filletNum
                );
                const fillet3 = makerjs.path.fillet(
                    currCutout.paths.line3,
                    currCutout.paths.line4,
                    filletNum
                );
                const fillet4 = makerjs.path.fillet(
                    currCutout.paths.line4,
                    currCutout.paths.line5,
                    filletNum
                );
                const fillet5 = makerjs.path.fillet(
                    currCutout.paths.line5,
                    currCutout.paths.line6,
                    filletNum
                );
                const fillet6 = makerjs.path.fillet(
                    currCutout.paths.line6,
                    currCutout.paths.line7,
                    filletNum
                );
                const fillet7 = makerjs.path.fillet(
                    currCutout.paths.line7,
                    currCutout.paths.line8,
                    filletNum
                );
                const fillet8 = makerjs.path.fillet(
                    currCutout.paths.line8,
                    currCutout.paths.line9,
                    filletNum
                );
                const fillet9 = makerjs.path.fillet(
                    currCutout.paths.line9,
                    currCutout.paths.line10,
                    filletNum
                );
                const fillet10 = makerjs.path.fillet(
                    currCutout.paths.line10,
                    currCutout.paths.line11,
                    filletNum
                );
                const fillet11 = makerjs.path.fillet(
                    currCutout.paths.line11,
                    currCutout.paths.line12,
                    filletNum
                );
                const fillet12 = makerjs.path.fillet(
                    currCutout.paths.line12,
                    currCutout.paths.line1,
                    filletNum
                );
