...
export class StabilizerMXLarge extends CutoutGenerator {
    ...
    generate(key, generatorOptions) {
        ...
        const upperBound = new Decimal("9")
        ...
        let upperLeft =  [minsHalfWidth.plus(generatorOptions.kerf).toNumber() - 0.125, upperBound.minus(generatorOptions.kerf).toNumber()]
        let upperRight = [plusHalfWidth.minus(generatorOptions.kerf).toNumber() + 0.125, upperBound.minus(generatorOptions.kerf).toNumber()]
        let lowerLeft =  [minsHalfWidth.plus(generatorOptions.kerf).toNumber() - 0.125, lowerBound.plus(generatorOptions.kerf).toNumber()]
        let lowerRight = [plusHalfWidth.minus(generatorOptions.kerf).toNumber() + 0.125, lowerBound.plus(generatorOptions.kerf).toNumber()]
